...
def check_current_plan_text(text: str) -> dict[str, str]:
    ...
    for label, clause in clauses.items():
        require(clause in value, f"current PLAN semantic clause missing: {label}")
