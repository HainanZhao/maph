"""Correct and deterministically seal the C72 blocker theorem."""
...
OUTPUT = ROOT / "artifacts/cycle-72-b072-defect-core-extension-v2.json"
HASHES = {
    "prior": ("artifacts/cycle-71-b071-high-star-defect-v1.json", "8417835fce57465f4f400c43999920adb4e25dc880e1ba72879dffcecfa9d8ba"),
    "sealed_v1": ("artifacts/cycle-72-b072-defect-core-extension-v1.json", "acac8b40d147cc9b126f1e3144cec40d31f3dc809c0a3c50effa1215284d1267"),
    "builder_v1": ("proof/build_cycle_72_generalized_blocker.py", "26960d9b7b1c52cc8909e960a3c214771e88fafba1cba7e861437900b2a97ba8"),
...
def audit():
    ...
    return {
        ...
        "resource_observation": {
            "source": "immutable v1 principal replay",
            "wall_seconds": 458.027,
            "child_user_seconds": 1354.948,
            "peak_child_rss_kib": 172044,
            "worker_processes": 3,
        },
...
def payload():
    result = audit()
    return {
        "artifact_id": "cycle-72-b072-defect-core-extension-v2",
        "budget_ordinal": "B072",
        "cycle": 72,
        "record_type": "CORRECTION_AND_PROVED_GENERALIZED_BLOCKER_THEOREM",
        "recorded_at_utc": "2026-08-05T16:27:00Z",
        "status": "SEALED",
        "epistemic_status": "PROVED",
        "outcome": "All 26,228,880 generalized D=5 equality cores have a universal five-blocker; consequently tau=6 forces D>=6.",
        "supersedes": "cycle-72-b072-defect-core-extension-v1",
        "correction": {
            "error": "The v1 builder embedded live wall-time, child-CPU, and peak-RSS measurements in its payload, so --check could not be byte-deterministic.",
            "cause": "Nondeterministic resource observations were treated as reconstructed artifact fields.",
            "affected_claims": "Artifact replay determinism only; the mathematical replay completed successfully and its theorem claims are unchanged.",
            "repair": "Freeze the immutable v1 principal-replay measurements as historical observations while rerunning all mathematical checks; omit live measurements from reconstructed payload fields."
        },
        ...
        "sealer": {"path": "proof/build_cycle_72_generalized_blocker_v2.py",
                   "sha256": sha256(Path(__file__))},
        "replay": {
            "check": "python3 proof/build_cycle_72_generalized_blocker_v2.py --check",
            "workers": 3,
