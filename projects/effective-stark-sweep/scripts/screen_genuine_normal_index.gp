...
joint_kernel_hnf(source_cyc, first_map, first_cyc, second_map, second_cyc) =
{
  ...
  if(#target_cyc == 0, return(matid(rank)));
...
run_screen() =
{
  ...
  if(#ray_common.cyc == 0,
    ...
    print("COMMON_RAY_CYC=[]");
    print("ONE_PLACE_RAY_CYC=", Vec(ray_one.cyc));
    print("CONJUGATE_RAY_CYC=", Vec(ray_conjugate.cyc));
    print("NORMAL_CLOSURE_RELATIVE_DEGREE=1");
    print("MAXIMAL_ABELIAN_RELATIVE_DEGREE=1");
    print("DERIVED_SUBGROUP_ORDER=1");
