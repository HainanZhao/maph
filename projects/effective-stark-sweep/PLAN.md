...
| Census manuscript | `BANKED` | Standalone five-page LaTeX/PDF manuscript compiles and its rendered claims are audited against frozen artifacts; it is locally frozen but not submitted or published | `paper/effective-stark-census.tex`, `paper/effective-stark-census.pdf`, `docs/cycle-091-census-manuscript-local-freeze.md` |
| Engine-B occurrence transport | `ACTIVE` | v5 scope manifest freezes 232 rows in 88 closures; no member transport has yet been promoted | `artifacts/engine-b-transport-manifest-v5.json`, `docs/cycle-090-engine-b-v5-transport-scope.md` |
