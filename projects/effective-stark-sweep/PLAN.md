...
| Census manuscript | `ACTIVE` | Standalone LaTeX/PDF draft compiles; claim-boundary audit is active and no submission action is authorized | `paper/effective-stark-census.tex`, `paper/effective-stark-census.pdf`, `scripts/audit_census_paper.py` |
