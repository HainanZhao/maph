...
identifications with support orders six or ten.  This historical
observation plays no role in the proofs.  This archimedean claim is
distinct from numerical and conditional
...
vanishes, the product is empty and \(X_A=1\).  An exact audit of the
frozen 1,560-row Engine-A queue finds 672 such characters among 2,232
supported character occurrences, affecting 603 rows; in 346 rows all
supported terms vanish.
\end{remark}
...
the main theorem of Voutier \cite[p.~82]{Voutier1996}, valid for
...
class \(r\), Shintani's Artin covariance
\eqref{eq:shintani-conclusion}, and the exact
