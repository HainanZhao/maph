...
\(j\), because it acts nontrivially on the imaginary quadratic base.
Put \(E^+=E^{\langle j\rangle}\) inside the common normal closure.
...
\(\sigma\) and \(j\) with complex conjugation.
\end{enumerate}
Then, for \(r\in\Z/4\Z\),
\[
 \boxed{\qquad
