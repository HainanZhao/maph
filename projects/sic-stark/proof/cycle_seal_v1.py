"""Shared immutable sealing scaffold for SIC--Stark proof cycles.

Breaking changes require a new, versioned scaffold so that sealed records stay
replayable against their recorded source.
"""
