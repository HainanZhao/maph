...
\[
 M\simeq\Q(\zeta_{60})^+.
\]
The uniqueness and the displayed isomorphism are checked exactly in
the archived \path{scripts/dimension_five_shintani_audit.gp}
transcript and independently in
...
\mathcal O_k&1&2&2&16&12h_kn=384\\
\mathfrak p_3&3&2&1&8&12f_{\mathfrak d}n=288\\
...
refinement of (40).  To handle the infinite-place swap exactly, embed
...
$R_0,R_1$.  That CM calculation would supply the phase and make (42),
...
8&15\text{ lower overlaps, quartic moduli, CM gate}
...
the raw comparison (40) suggests; its remaining obstruction is the
