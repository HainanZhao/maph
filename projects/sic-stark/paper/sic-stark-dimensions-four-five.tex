...
A companion paper applies the same convention-audited bridge to
...
that platform. A tagged immutable source archive will contain the
files below and a self-verifying root manifest named
\texttt{ARCHIVE\_CONTENTS.sha256}. It will be deposited with Zenodo
and its DOI inserted in the final submission. A repository
