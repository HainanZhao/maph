...
the finite Zak descent.  Equation (10) is a boundary identity only.
...
closed ${}_2\psi_2$ locus (12).  The dimension-six packet lies on its
sign-reflected neighbor (10).
\end{proposition}
...
This control is decisive: the minus sign in (10) is not a dispensable
